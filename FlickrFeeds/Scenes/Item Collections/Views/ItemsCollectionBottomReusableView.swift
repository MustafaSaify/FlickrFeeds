//
//  ItemCollectionViewBottomReusableView.swift
//  FlickrFeeds
//
//  Created by Mustafa Saify on 14/01/19.
    ...
    var state: State = .idle {
        didSet {
            ...
            case .tryAgain(let message):
                ...
                tryAgainButton.setAttributedTitle(tryAgainAttributedTitleWithMessage(message, font: tryAgainButton.titleLabel!.font), for: UIControl.State())
            }
        }
    }
